...
describe("Verify variables, cypress commands and jquery commands", () => {
    it.skip("Navigating to pages with variables", () => {
        ...
        const makeupLink = cy.get('ul.categorymenu li a[href*="product/category&path="]').contains('Makeup')
        const skincareLink = cy.get('ul.categorymenu li a[href*="product/category&path="]').contains('Skincare')
        makeupLink.click()
        skincareLink.click()
    })
    ...
    it("Navigating to pages without using variables", () => {
        ...
        cy.visit('https://www.automationteststore.com/')
        cy.get('ul.categorymenu li a[href*="product/category&path="]').contains('Makeup').click()
        cy.get('ul.categorymenu li a[href*="product/category&path="]').contains('Skincare').click()
    })
